...
const SEO: React.FC<SEOProps> = ({
  title = 'CogniSim AI',
  description = 'CogniSim AI: Revolutionary multi-agent AI system that transforms Product Owners from administrative coordinators into strategic product leaders. Save 40% time on administrative tasks.',
  type = 'website',
  name = 'CogniSim AI',
  ...
  const currentUrl = `https://cognisim-ai.com${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith('http') ? imageUrl : `https://cognisim-ai.com${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    '@type': 'Organization',
    name: 'CogniSim AI',
    url: 'https://cognisim-ai.com',
    logo: 'https://cognisim-ai.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
    description: 'Revolutionary multi-agent AI system for product management transformation',
    contactPoint: {
      '@type': 'ContactPoint',
    ...
    sameAs: [
      'https://www.linkedin.com/in/hammadahmed06',
      'https://twitter.com/cognisim_ai'
    ]
  };
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://cognisim-ai.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
        width: 512,
        height: 512
      },
      url: 'https://cognisim-ai.com'
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="CogniSim AI" />
      <meta property="og:locale" content="en_US" />
      {isBlogPost && category && <meta property="article:section" content={category} />}
      {isBlogPost && publishDate && <meta property="article:published_time" content={publishDate} />}
      {isBlogPost && modifiedDate && <meta property="article:modified_time" content={modifiedDate} />}
      {isBlogPost && <meta property="article:publisher" content="https://cognisim-ai.com" />}
      ...
      <meta name="twitter:site" content="@cognisim_ai" />
      <meta name="twitter:creator" content="@cognisim_ai" />
