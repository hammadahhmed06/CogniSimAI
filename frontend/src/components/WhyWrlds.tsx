...
const WhyCognisimAI = () => {
  ...
  return <section id="why-cognisim-ai" className="relative py-16 md:py-24 bg-white overflow-hidden">
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        margin: "-100px"
          ...
          <motion.p variants={itemVariants} className="text-gray-600 text-lg max-w-3xl mx-auto">
            In an industry where complexity leads to failure, we bring AI-powered simplicity and expertise to ensure your product success
          </motion.p>
        </motion.div>
        ...
        <motion.div className="mb-12" initial="hidden" whileInView="visible" viewport={{
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              What CogniSim AI Does for You
            </h3>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We transform your ideas into AI-powered market-ready solutions with tangible benefits for your business
            </p>
          </motion.div>
