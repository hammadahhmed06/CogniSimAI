...
export function CognisimSignupForm({
  className,
  ...props
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Enforce strong password: min 8, lower/upper/digit/symbol
    if (!meetsAllPasswordRequirements(formData.password, 8)) {
  ...
  const handleGitHubSignUp = async () => {
    try {
      setIsLoading(true)
      setError('')
      const { error } = await AuthService.signInWithProvider('github')
      if (error) {
        setError(error.message)
      }
      // The useEffect above will handle navigation when auth state updates
          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-slate-300">Choose how you&apos;d like to get started</p>
              </div>
                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                  ...
                  <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      name="password"
                      type="password"
                      placeholder="At least 8 chars, lower/upper/digit/symbol"
                      ...
                      className="border-white/20 bg-white/5 text-slate-100 placeholder:text-slate-400 focus-visible:ring-sky-500"
                    />
                    <PasswordRequirements password={formData.password} className="mt-1" theme="dark" />
                  </div>
              ...
              <div className="text-center text-sm text-slate-300">
                ...
                <a href="/auth/login" className="text-sky-300 underline underline-offset-4">
                  Sign in
                </a>
              </div>
            </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <div className="text-center text-slate-200">
                ...
                <p className="text-slate-200">
                  Transform your product management with intelligent AI agents that understand your workflow.
                </p>
                <div className="mt-6 space-y-2 text-sm text-slate-200">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Epic decomposition automation</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
                    </svg>
                    <span>Smart estimation intelligence</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
                    </svg>
                    <span>Intelligent sprint planning</span>
                  </div>
                </div>
              </div>
            </div>
