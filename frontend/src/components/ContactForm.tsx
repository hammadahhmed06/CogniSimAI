...
const ContactForm = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_name: 'CogniSim AI Team', // Adding recipient name parameter
      ...
      // More detailed error logging without using any
      if (error && typeof error === 'object' && 'text' in error) {
        const maybeText = (error as Record<string, unknown>).text;
        if (typeof maybeText === 'string') {
          console.error('Error details:', maybeText);
        }
      }
  ...
  return <section id="contact-info" className="bg-gradient-to-b from-white to-black text-white relative py-[25px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-700 text-black">
              ...
              <a href="mailto:hammadahhmed06@gmail.com" className="text-blue-500 hover:underline">hammadahhmed06@gmail.com</a>
