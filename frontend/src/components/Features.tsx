...
const Features = () => {
  ...
  const stepFlowItems = [{
    ...
    title: "CogniSim AI Proprietary Modules",
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              <Carousel className="w-full max-w-7xl mx-auto">
                ...
                <div className="flex justify-center mt-6 gap-2">
                  <CarouselPrevious className="relative left-auto translate-y-0 hover:bg-gray-100" />
                  <CarouselNext className="relative right-auto translate-y-0 hover:bg-gray-100" />
                </div>
              </Carousel>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              CogniSim AI builds hardware and software with proprietary and off-the-shelf modules, 
              allowing us to develop completely unique AI solutions at high speed and lower risk.
            </p>
          </div>
