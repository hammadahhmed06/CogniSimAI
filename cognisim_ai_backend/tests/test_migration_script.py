...
_migration_spec = importlib.util.find_spec("migrate_credentials")
if _migration_spec is None:  # pragma: no cover
    pytest.skip(
        "Optional migrate_credentials module not present; skipping migration-script tests.",
